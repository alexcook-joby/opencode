...
Export current conversation to Markdown and open in your default editor. User display names in the export are escaped for Markdown safety, and the command uses the editor set in your `EDITOR` environment variable. [Learn more](#editor-setup).
